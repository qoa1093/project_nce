...
public class BaseballGame2 {
	...
	public static void main(String[] args) {
		...
		do {
			// 숫자 입력 : 반복문과 scanner를 이용하여 정수 3개 입력
			System.out.print("입력: ");
	...
	/* 기능 	:	배열 arr에 0번지부터 count개까지 확인하여 정수 num가 있는지 없는지 알려주는 메소드 
	 * 매개변수:	배열arr, 갯수 count,정수 num => int[]arr, int count, int num
	 * 리턴타입: 있는지 없는지 ->boolean
	 * 메소드명: contains
	 * 설명 	: [1,2,3,4,5] 배열에서 처음부터 3개중에서 5가 있는지 없는지 확인 => x
	 *  	  [1,2,3,4,5] 배열에서 처음부터 5개중에서 5가 있는지 없는지 확인 => o
	 * */
	...
	/* 기능 : 배열 arr 주어지면 주어진 배열에 min~max 사이의 랜덤한 수를 생성하여 중복되지않게 저장하는 메스도
	 ...
	 * 매개변수 : 배열 arr,배열arr2 => int []arr1, int []arr2
