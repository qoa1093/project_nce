...
public class MethodEx6 {
	...
	public static void printChar1(char ch,int num1) {
	...
	public static void printChar2(char ch, int num1) {
		for(int i=1;i<=num1;i+=1) {
			for(int j=num1-1;j>=i;j-=1) {
				System.out.print(" ");
			}
			for(int k=1;k<=i;k+=1) {
				System.out.print(ch);
	 ...
	 * 매개변수 : 문자, n줄, 삼각형 종류 => char ch, int n, TriangleShape
	 * 리턴타입 : 없음 => void
	 * 메소드명 : printTriangle */
