...
public class TryTest1 {
	...
	public static void main(String[] args) {
		 ...
		 * ArithmeticException -> RuntimeException -> Exception(조상님)*/
		...
		//RuntimeException은 ArithmeticException의 부모이기 때문에 예외 처리 가능하다
		...
		catch(ClassCastException e) {								//예외처리 안되서 프로그램 중단됨. 마지막 프로그램종료 출력x
			System.out.println("예외 발생 : 0으로 나눌 수 없습니다.");
		}
