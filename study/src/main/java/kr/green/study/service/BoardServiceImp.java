...
public class BoardServiceImp implements BoardService{
	...
	private String uploadThumbnailPath = "C:\\Users\\chaennn\\Desktop\\JAVA_NCE\\JAVA_NCE\\project_nce\\study\\src\\main\\webapp\\resources\\img";
	...
	public void updateBoard(BoardVO board, MemberVO user, MultipartFile[] fileList, Integer[] fileNumList) throws Exception {
		...
		if(dbFileNumList != null) {
			...
			//[1,2,3] [3]
			//dbFileNumList에 있는첨부파일 번호들 중에서 inputFileNumList에 없는 첨부파일을 삭제
